...
DAQ_FIELDS = ["time_ms", "shock_rl_mm", "shock_rr_mm", "shock_rl_raw", "shock_rr_raw", "brake_pressure_front_psi", "brake_pressure_front_raw", "brake_pressure_back_psi", "brake_pressure_back_raw"]
